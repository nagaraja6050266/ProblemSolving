...
public class CustomersDao {
    ...
    public Customer addCustomer(Customer customer) throws SQLException {
        String query = "insert into customers (customerName,phNumber) values(?,?)";
    ...
    public int editCustomer(int id, Customer customer) throws SQLException {
        String query = "update customers set customerName=?,phNumber=? where customerId=?";
        PreparedStatement statement = connection.prepareStatement(query);
        statement.setString(1, customer.getCustomerName());
        statement.setString(2, customer.getPhNumber());
    ...
    private Customer createCustomer(ResultSet resultSet) throws SQLException {
        return new Customer(resultSet.getInt("customerId"), resultSet.getString("customerName"), resultSet.getString("phNumber"));
    }
}
